...
{
    string s = categoryID();
    Product* bookAdd = new Book(s, prodName_, price_, qty_, isbn_, author_);
    return bookAdd;
}
...
{
    string s = categoryID();
    Product* clothingAdd = new Clothing(s, prodName_, price_, qty_, size_, brand_);
    return clothingAdd;
}
...
{
    string s = categoryID();
    Product* movieAdd = new Movie(s, prodName_, price_, qty_, genre_, rating_);
    return movieAdd;
}
